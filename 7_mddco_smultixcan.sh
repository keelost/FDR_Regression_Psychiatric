...
phenotypes=('bd2018' 'cannabis' 'dx.dep' 'ed2019' 'edu' 'inte' 'neuroti2018' 'ocd2018' 'scz.eas2019' 'wal.scz2018' 'mddco')
...
--metaxcan_folder /exeh_4/jinghong_qiu/SO_Lab/level2/metaxcan_1_all/mddco/ \
--metaxcan_filter  gtex_v7_${T}.${b} \
--metaxcan_file_name_parse_pattern 'gtex_v7_(.*).overlap.4magma.txt_in_(.*).csv' \
--gwas_file /exeh_4/jinghong_qiu/SO_Lab/level2/overlapping_1_all/mddco/${T}.overlap.txt \
--snp_column snpid \
...
--verbosity 7 \
--throw \
--output /exeh_4/jinghong_qiu/SO_Lab/level2/smultixcan_1_all/mddco/${T}.allbrain.txt \
