...
phenotypes=('ad' 'alco2018' 'asd2019' 'cannabis' 'college2013' 'dx.dep' 'ed2019' 'edu' 'ever.csh' 'ever.sh' 'ever.st' 'life.threat.accident' 'mdd2019' 'mddco' 'neuroti2018' 'no.dep' 'ocd2018' 'ptsd2019' 'sleep.dura' 'wal.scz2018' 'bd2012')
...
--metaxcan_folder /exeh_4/jinghong_qiu/SO_Lab/level2/magma_2_lasso/bd2012/ \
--metaxcan_filter  gtex_v7_${T}.${b} \
--metaxcan_file_name_parse_pattern 'gtex_v7_(.*).overlap.4magma.txt_in_(.*).csv' \
--gwas_file /exeh_4/jinghong_qiu/SO_Lab/level2/overlapping_2_lasso/bd2012/${T}.overlap.txt \
--snp_column snpid \
...
--verbosity 7 \
--throw \
--output /exeh_4/jinghong_qiu/SO_Lab/level2/smultixcan_2_lasso/bd2012/${T}.allbrain.txt \
