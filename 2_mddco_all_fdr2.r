...
#R-353
	...
	setwd('/exeh_4/jinghong_qiu/SO_Lab/level2/fdr_2_lasso/mddco')

#----Loading data----#
#Target
	target=fread('/exeh_4/jinghong_qiu/SO_Lab/level2/overlapping_2_lasso/mddco/mddco.overlap.txt')

#Variants with no sample overlap
	listnames_no = c('bd2018','cannabis','dx.dep','ed2019','edu','ocd2018','scz.eas2019','mdd2019')
	files_no=lapply(paste0('/exeh_4/jinghong_qiu/SO_Lab/level2/overlapping_2_lasso/mddco/',listnames_no,'.overlap.txt'),fread,stringsAsFactor=F)
#Variants with sample overlap
	listnames_with = c('inte','neuroti2018','wal.scz2018')
	files_with =lapply(paste0('/exeh_4/jinghong_qiu/SO_Lab/level2/overlapping_2_lasso/mddco/',listnames_with,'.overlap.txt'),fread,stringsAsFactor=F)
...
#----Run fdr.reg function(For all data)----#
	...
	colnames(features) = c('inte','neuroti2018','wal.scz2018','bd2018','cannabis','dx.dep','ed2019','edu','ocd2018','scz.eas2019','mdd2019')
...
#assessment-fdrr
	 ...
	 fwrite(as.data.frame(assessment),'/exeh_4/jinghong_qiu/SO_Lab/Contribution/snp-mddco-all.csv',sep=',')
...
#----Compare FDR-reg result----#
	...
	fwrite(as.data.frame(sum_data),'/exeh_4/jinghong_qiu/SO_Lab/level2/Result_table/snp_mddco.add.csv',sep=',')
	
	save(fdr.st,fdr.st2,file = "/exeh_4/jinghong_qiu/SO_Lab/level2/FDR_models/snp_mddco.add.RData")

#----Get the magma data----#
	setwd('/exeh_4/jinghong_qiu/SO_Lab/level2/magma_2_lasso/mddco')
