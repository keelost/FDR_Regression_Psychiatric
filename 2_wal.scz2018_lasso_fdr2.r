...
#R-353
	...
	setwd('/exeh_4/jinghong_qiu/SO_Lab/level2/fdr_2_lasso/wal.scz2018')

#----Loading data----#
#Target
	target=fread('/exeh_4/jinghong_qiu/SO_Lab/level2/overlapping_2_lasso/wal.scz2018/wal.scz2018.overlap.txt')

#Variants with no sample overlap
	listnames_no = c('asd2019','cannabis','chrono','dx.dep','dx.life.threat.ill','ever.csh','ever.sh','life.threat.accident','neuroti2018','no.dep','ocd2018','pd','wit.death')
	files_no=lapply(paste0('/exeh_4/jinghong_qiu/SO_Lab/level2/overlapping_2_lasso/wal.scz2018/',listnames_no,'.overlap.txt'),fread,stringsAsFactor=F)
#Variants with sample overlap
	...
	files_with =lapply(paste0('/exeh_4/jinghong_qiu/SO_Lab/level2/overlapping_2_lasso/wal.scz2018/',listnames_with,'.overlap.txt'),fread,stringsAsFactor=F)
...
#----Run fdr.reg function(For all data)----#
	...
	colnames(features) = c('ad','adhd2019','alco2018','anx','bd2018','ed2019','ever.st','mdd2019','mddco','physical.crime','psycho.experi','ptsd2019','reac','sleep.dura','smoking','st','st.dep','tense','asd2019','cannabis','chrono','dx.dep','dx.life.threat.ill','ever.csh','ever.sh','life.threat.accident','neuroti2018','no.dep','ocd2018','pd','wit.death')
#assessment-fdrr
	 library(HelpersMG)
	 ...
	 fwrite(as.data.frame(assessment),'/exeh_4/jinghong_qiu/SO_Lab/Contribution/snp-scz2018-lasso.csv',sep=',')	
#----Get the qval----#
...
#----Compare FDR-reg result----#
	...
	fwrite(as.data.frame(sum_data),'/exeh_4/jinghong_qiu/SO_Lab/level2/Result_table/snp_wal.scz2018.lasso.csv',sep=',')
	
	save(fdr.st,fdr.st2,file = "/exeh_4/jinghong_qiu/SO_Lab/level2/FDR_models/snp_wal.scz2018.lasso.RData")

#----Get the magma data----#
	setwd('/exeh_4/jinghong_qiu/SO_Lab/level2/magma_2_lasso/wal.scz2018')
