...
#Save final result
	fwrite(as.data.frame(target.gene.order),file=paste0('bd2018.finalresult.txt'),sep=' ')
	...
	save(fdr.theore,fdr.empiri,fdr.target.theore,fdr.target.empiri,lasso.fdr.target.theore,lasso.fdr.target.empiri,file = "/exeh_4/jinghong_qiu/SO_Lab/level2/FDR_models/smulti-bd2018.RData")
#exit the software
	q('no') 