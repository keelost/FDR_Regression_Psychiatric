...
if (!nzchar(base_output_path)) stop('Set FDRREG_RESULTS_DIR before running z-score sensitivity analysis.')
...
metaxcan_input_dir <- file.path(base_output_path, target_name, '06.metaxcan')
