...
#R-353
	...
	setwd('/exeh_4/jinghong_qiu/SO_Lab/level2/fdr_2_lasso/bd2012')

#----Loading data----#
#Target
	target=fread('/exeh_4/jinghong_qiu/SO_Lab/level2/overlapping_2_lasso/bd2012/bd2012.overlap.txt')

#Variants with no sample overlap
	listnames_no = c('ad','asd2019','cannabis','college2013','dx.dep','edu','ever.csh','ever.sh','ever.st','life.threat.accident','mddco','neuroti2018','no.dep','ocd2018','ptsd2019','sleep.dura','wal.scz2018')
	files_no=lapply(paste0('/exeh_4/jinghong_qiu/SO_Lab/level2/overlapping_2_lasso/bd2012/',listnames_no,'.overlap.txt'),fread,stringsAsFactor=F)
#Variants with sample overlap
	listnames_with = c('alco2018','ed2019','mdd2019')
	files_with =lapply(paste0('/exeh_4/jinghong_qiu/SO_Lab/level2/overlapping_2_lasso/bd2012/',listnames_with,'.overlap.txt'),fread,stringsAsFactor=F)
...
#----Run fdr.reg function(For all data)----#
	...
	colnames(features) = c('alco2018','ed2019','mdd2019','ad','asd2019','cannabis','college2013','dx.dep','edu','ever.csh','ever.sh','ever.st','life.threat.accident','mddco','neuroti2018','no.dep','ocd2018','ptsd2019','sleep.dura','wal.scz2018')
#assessment-fdrr
	 library(HelpersMG)
	 ...
	 fwrite(as.data.frame(assessment),'/exeh_4/jinghong_qiu/SO_Lab/Contribution/snp-bd2012.lasso.csv',sep=',')	
#----Get the qval----#
...
#----Compare FDR-reg result----#
	...
	fwrite(as.data.frame(sum_data),'/exeh_4/jinghong_qiu/SO_Lab/level2/Result_table/snp_bd2012.lasso.csv',sep=',')
	
	save(fdr.st,fdr.st2,file = "/exeh_4/jinghong_qiu/SO_Lab/level2/FDR_models/snp_bd2012.lasso.RData")

#----Get the magma data----#
	setwd('/exeh_4/jinghong_qiu/SO_Lab/level2/magma_2_lasso/bd2012')
